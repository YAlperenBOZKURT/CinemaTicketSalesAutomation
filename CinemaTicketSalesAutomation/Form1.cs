...
{
    public partial class Sinema_Seanslari : Form
    {
        public Sinema_Seanslari()
        {
            InitializeComponent();
        }
        ...
        private void ListControls ()
        {
            ...
            for (int i = 0; i < movies.Count; i++)
            {
                ...
                if (this.Width > x + xIncrement + picture.Width)
                {
                    x += xIncrement;
                }
                else
        ...
        private void button_click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Seçilen Seansi kaçırdınız. Başka seansi seçiniz lütfen !");
                return;
            }
            this.Hide();
            form2.Show();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            lblNow.Text = dateTime.ToLongTimeString();
        }
    }
}
